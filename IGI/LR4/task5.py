...
class MatrixAnalysis:
    ...
    def __str__(self) -> str:
        ...
        summary = (
            ...
            f"Стандартное отклонение (встроенная функция): {std_b:.2f}\n"
            f"Стандартное отклонение (вычислено вручную): {std_m:.2f}"
        )
        return summary
...
def main():
    ...
    while True:
        ...
        if selected_elements.size == 0:
            ...
            std_builtin_val = analysis.std_builtin(selected_elements)
            std_manual_val = analysis.std_manual(selected_elements)
